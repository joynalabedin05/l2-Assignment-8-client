...
const Footer = () => {
    return (
        <div className="mb-10">
            <div className="flex justify-between max-w-[1200px] mx-auto p-10 bg-slate-500 w-full h-full">
            ...
            <p className="bg-base-200 text-base-content">Copyright © 2024 - All right reserved by ACME Industries Ltd</p>
            </div>
        </div>
    );
};
